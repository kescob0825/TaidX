...
*/
    ...
    private class Year {
        ...
        public int getValue() {return Integer.parseInt(yearElement.getAttributeValue("year"));}
    ...
    private class Month {
        ...
        public int getValue() {
            return Integer.parseInt(mElement.getAttributeValue("month"));
        }
...
*/
    ...
    private class Day {
        ...
        public int getValue() {
            return Integer.parseInt(dEl.getAttributeValue("day"));
        }
