...
public class Projects extends JPanel{
    ...
    private int getOpenUsSum(List<UserStoryNode> projectUserStoryList) {
        ...
        System.out.println("Total stories: " + projectUserStoryList.size());
        System.out.println("Open stories: " + openUSSum);
        System.out.println("Closed stories: " + (projectUserStoryList.size() - openUSSum));
        return openUSSum;
    }
