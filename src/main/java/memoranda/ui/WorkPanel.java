...
public class WorkPanel extends JPanel {
	...
	//Scrum
	//JButton sprintButton = createSubmenuButton("Sprint Planning");  commented out due to not needed. 
	...
	void jbInit() throws Exception {
		...
		//change needed to avoid hardcoded data
		String currentUserName = "t36222";
		statsCards = new StatsToolBarCards(cardLayout, panel, currentUserName);
